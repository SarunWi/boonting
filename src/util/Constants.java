...
public class Constants {
	public static final String WAITING_CNFRM_FROM_SELLER_STATE = "WatingConfirmFromSeller";
	public static final String CNFRM_SALES_ORDER_STATE = "ConfirmSalesOrder";
